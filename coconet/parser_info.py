...
_OPTIONS = {
    ...
    'frag': [
        click.option('--fragment-step', type=int, required=False, default=128, help='Fragments spacing'),
        click.option('--n-train', type=int, required=False, default=int(1e6), help='Number of training examples'),
        click.option('--n-test', type=int, required=False, default=int(1e4),help='Number of test examples')
    ],
